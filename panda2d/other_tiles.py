# -*- coding: utf-8 -*-
"""This is another implementation of the tilemap. It uses a MeshDrawer that should be faster. though in my notebook (which lacks shaders) it ran slower.
also it has limitations (like all the tiles must have the same size.) And im not sure that i can set the Y coords per tile. which is nice for
pseudo Z (or Y actually).
also i updated the other code so this lacks some stuff.
Needs testing. ofc
"""
import json
